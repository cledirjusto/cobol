      ...
      *******************************************************************
      ...
      -"I   J   K   L   M     ".
       ...
       VALUE "                        имммямммямммямммямммямммямммямммям
      -"ммямммямммямммяммм╩   ".
       ...
       VALUE "                        гдддедддедддедддедддедддедддедддед
      -"ддедддедддедддеддд╤   ".
       ...
       VALUE " Grid Coordinates:      гдддедддедддедддедддедддедддедддед
      -"ддедддедддедддеддд╤   ".
       ...
       HIGHLIGHT VALUE "                        гдддедддедддедддедддеддд
      -"едддедддедддедддедддедддеддд╤   ".
         02 LINE 12 COL 1 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6
       HIGHLIGHT VALUE " Damage Report:       4 ╨ ".
         02 COL 28 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
         02 COL 32 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
       ...
       HIGHLIGHT VALUE " ".
         02 COL 22 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       "   гдддедддедддедддедддедддедддедддедддедддедддедддеддд╤   ".
       ...
       HIGHLIGHT VALUE " key:                   гдддедддедддедддедддеддд
      -"едддедддедддедддедддедддеддд╤   ".
         02 LINE 16 COL 1 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6
       HIGHLIGHT VALUE "  A Aircraft Carrier  6 ╨ ".
         02 COL 28 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
         02 COL 32 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
       ...
       HIGHLIGHT VALUE "  B Battleship          гдддедддедддедддедддеддд
      -"едддедддедддедддедддедддеддд╤   ".
         02 LINE 18 COL 1 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6
       HIGHLIGHT VALUE "  F Frigate           7 ╨ ".
         02 COL 28 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
         02 COL 32 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
       ...
       HIGHLIGHT VALUE "  G Gun Boat            гдддедддедддедддедддеддд
      -"едддедддедддедддедддедддеддд╤   ".
         02 LINE 20 COL 1 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6
       HIGHLIGHT VALUE "  * Damaged Ship      8 ╨ ".
         02 COL 28 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
         02 COL 32 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " Ё ".
       ...
       "  ".
         02 COL 4 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " hit                 гдддедддедддедддедддедддедддедддедддедддедд
      -"дедддеддд╤   ".
       ...
       "  ".
         02 COL 4 BACKGROUND-COLOR 1 FOREGROUND-COLOR 6 HIGHLIGHT VALUE
       " miss                хмммомммомммомммомммомммомммомммомммомммомм
      -"момммоммм╪   ".
